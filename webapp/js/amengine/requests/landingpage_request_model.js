...
define(['backbone', 'constantsrequestmodel', 'initialpagerequestmodel', 'baserequestmodel', 'landingpagerequestmodel'], function (Backbone, CM, InitialPageRequestModel, BaseRequestModel, LandingPageRequestModel) {
    "use strict";
    var C = {
