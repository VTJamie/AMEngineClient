...
define(['backbone', 'constantsrequestmodel', 'textmodel', 'selectmodel', 'buttonmodel', 'datemodel', 'complexitemlistmodel', 'gridmodel', 'layouteditormodel', 'workflowindicatormodel', 'filecontrolmodel'], function (Backbone, CM, TextControlModel, SelectControlModel, ButtonControlModel, DateControlModel, ComplexListItemControlModel, GridControlModel, LayoutEditorControlModel, WorkflowIndicatorControlModel, FileControlModel) {
    ...
    var constants = {
        ...
        ButtonGroupModel, CollapsibleGroupModel, TableGroupModel, ControlCollection;
    ...
    ControlCollection = Backbone.Collection.extend({
        model: function (attrs, options) {
            ...
            if (attrs[CM.get(constants.GROUP_TYPE)] !== undefined) {
                ...
                } else if (attrs[CM.get(constants.GROUP_TYPE)] === constants.GROUP_TYPE_COLLAPSIBLE || attrs[CM.get(constants.GROUP_TYPE)] === CM.get(constants.GROUP_TYPE_COLLAPSIBLE) || attrs[constants.GROUP_TYPE] === constants.GROUP_TYPE_COLLAPSIBLE || attrs[constants.GROUP_TYPE] === CM.get(constants.GROUP_TYPE_COLLAPSIBLE)) {
                ...
                } else if (attrs[CM.get(constants.CONTROL_TYPE)] === constants.CONTROL_TYPE_BUTTON || attrs[CM.get(constants.CONTROL_TYPE)] === CM.get(constants.CONTROL_TYPE_BUTTON) || attrs[constants.CONTROL_TYPE] === constants.CONTROL_TYPE_BUTTON || attrs[constants.CONTROL_TYPE] === CM.get(constants.CONTROL_TYPE_BUTTON)) {
                    return new ButtonControlModel(attrs);
                } else if (attrs[CM.get(constants.CONTROL_TYPE)] === constants.CONTROL_TYPE_DATE || attrs[CM.get(constants.CONTROL_TYPE)] === CM.get(constants.CONTROL_TYPE_DATE) || attrs[constants.CONTROL_TYPE] === constants.CONTROL_TYPE_DATE || attrs[constants.CONTROL_TYPE] === CM.get(constants.CONTROL_TYPE_DATE)) {
                    return new DateControlModel(attrs);
                } else if (attrs[CM.get(constants.CONTROL_TYPE)] === constants.CONTROL_TYPE_GRID || attrs[CM.get(constants.CONTROL_TYPE)] === CM.get(constants.CONTROL_TYPE_GRID) || attrs[constants.CONTROL_TYPE] === constants.CONTROL_TYPE_GRID || attrs[constants.CONTROL_TYPE] === CM.get(constants.CONTROL_TYPE_GRID)) {
                    return new GridControlModel(attrs);
                } else if (attrs[CM.get(constants.CONTROL_TYPE)] === constants.CONTROL_TYPE_COMPLEX_ITEM_LIST || attrs[CM.get(constants.CONTROL_TYPE)] === CM.get(constants.CONTROL_TYPE_COMPLEX_ITEM_LIST) || attrs[constants.CONTROL_TYPE] === constants.CONTROL_TYPE_COMPLEX_ITEM_LIST || attrs[constants.CONTROL_TYPE] === CM.get(constants.CONTROL_TYPE_COMPLEX_ITEM_LIST)) {
                    return new ComplexListItemControlModel(attrs);
                } else if (attrs[CM.get(constants.CONTROL_TYPE)] === constants.CONTROL_TYPE_LAYOUT_EDITOR || attrs[CM.get(constants.CONTROL_TYPE)] === CM.get(constants.CONTROL_TYPE_LAYOUT_EDITOR) || attrs[constants.CONTROL_TYPE] === constants.CONTROL_TYPE_LAYOUT_EDITOR || attrs[constants.CONTROL_TYPE] === CM.get(constants.CONTROL_TYPE_LAYOUT_EDITOR)) {
                    return new LayoutEditorControlModel(attrs);
                } else if (attrs[CM.get(constants.CONTROL_TYPE)] === constants.CONTROL_TYPE_WORKFLOW_INDICATOR || attrs[CM.get(constants.CONTROL_TYPE)] === CM.get(constants.CONTROL_TYPE_WORKFLOW_INDICATOR) || attrs[constants.CONTROL_TYPE] === constants.CONTROL_TYPE_WORKFLOW_INDICATOR || attrs[constants.CONTROL_TYPE] === CM.get(constants.CONTROL_TYPE_WORKFLOW_INDICATOR)) {
                    return new WorkflowIndicatorControlModel(attrs);
                } else if (attrs[CM.get(constants.CONTROL_TYPE)] === constants.CONTROL_TYPE_FILE || attrs[CM.get(constants.CONTROL_TYPE)] === CM.get(constants.CONTROL_TYPE_FILE) || attrs[constants.CONTROL_TYPE] === constants.CONTROL_TYPE_FILE || attrs[constants.CONTROL_TYPE] === CM.get(constants.CONTROL_TYPE_FILE)) {
