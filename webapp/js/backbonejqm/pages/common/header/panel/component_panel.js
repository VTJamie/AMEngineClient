...
define(['jquery', 'backbone', 'backbone-jquerymobileview', 'headermodel', 'app', 'hbs!pages/common/header/panel/template_panel'], function ($, Backbone, jqmView, HeaderModel, App, Template) {
    "use strict";
