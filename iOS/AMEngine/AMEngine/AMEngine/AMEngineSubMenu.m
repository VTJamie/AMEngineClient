...
@implementation AMEngineSubMenu
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) 
    {
        ...
        UIBarButtonItem* cancelbutton = [[UIBarButtonItem alloc] initWithTitle:@"Cancel" style:UIBarButtonItemStyleDone target:self action:@selector(dismissAMEngineMenu)];
...
//{
//    AMEngineMain* newviewcontroller = [[AMEngineMain alloc] initWithMenu:nil showLogoutButton:NO];
...
- (void) forTableViewController: (AssistedTableView*) tableController didSelectRowAtIndexPath: (NSIndexPath*) indexPath
{
  ...
  //  NSLog(@"%@", fieldvalues);
    ...
    AMEngineMain* newview = [[AMEngineMain alloc] initWithMenu:nil showLogoutButton:NO];
