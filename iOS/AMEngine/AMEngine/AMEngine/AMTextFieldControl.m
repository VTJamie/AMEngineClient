...
{    
    [[(AMEngineLayoutView*)[self superview] getTopParent] refreshControls:[[refreshresponse objectForKey:[AMConstants C:RESPONSE_BODY]] objectForKey:[AMConstants C:CONTROL_ARRAY]]];    
}
