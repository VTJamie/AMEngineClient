...
+ (void) fillConstantsWithTarget: (id) target andSelector: (SEL) afterloadselector
{
    ...
    [AMEngineDataManager sendRequest:postdata withTarget:[[AMConstants alloc] initWithInitializingTarget:target andSelector:afterloadselector] andSelector:@selector(dataManager:jsonresponse:)];
    //NSString* response = [AMEngineDataManager sendSynchronousRequest:postdata];
