...
- (void) reloadMenu
{
    ...
    [AMEngineDataManager sendRequest:postdata withTarget:self andSelector:@selector(dataManager:Menuresponse:)];
...
- (void) forTableViewController: (AssistedTableView*) tableController didSelectRowAtIndexPath: (NSIndexPath*) indexPath
{
    ...
    {
        AMEngineMenu* newmenu = [[AMEngineMenu alloc] init];
