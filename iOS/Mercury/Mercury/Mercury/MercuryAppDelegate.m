...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [MercuryDataManager registerDefaultsFromSettingsBundle];
...
{
    MercuryMenu* menu = [[MercuryMenu alloc] init];
    UINavigationController* menunav = [[UINavigationController alloc] initWithRootViewController:menu];
    MercuryMain* mainview = [[MercuryMain alloc] initWithMenu:menunav];
