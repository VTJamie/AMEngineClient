...
@implementation MercuryDateControl
...
-(void) buttonClick
{
    ...
    MercuryDatePickerView* datepicker = [[MercuryDatePickerView alloc] initWithTarget:self andStartDate:date];
