...
define(['jquery', 'backbone', 'modernizr', 'backbone-jquerymobileheader', 'headermodel', 'app', 'hbs!pages/common/header/template_header'], function ($, Backbone, Mod, jqmHeader, HeaderModel, App, Template) {
    "use strict";
    ...
    var HeaderView = jqmHeader.extend({
        initialize: function (options) {
            ...
            this.model = new HeaderModel(this.options.modelvalues);
